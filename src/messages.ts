export var messages = {
    ...
    keysFileInvalid: "the keys file $1 does not have the expected format",
    ...
    userCreated: "user $1 created in $2",
    usernameLabel: "Username",
    usersFileInvalid: "the users file $1 does not have the expected format",
}
...
export var i18n:{
    ...
    messages:{
        ...
        es:{
            ...
            keysFileInvalid: "el archivo de claves $1 no tiene el formato esperado",
            ...
            userCreated: "usuario $1 dado de alta en $2",
            usernameLabel: "Usuario",
            usersFileInvalid: "el archivo de usuarios $1 no tiene el formato esperado",
        }
    }
}
